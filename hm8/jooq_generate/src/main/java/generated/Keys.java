...
public class Keys {
    ...
    public static final ForeignKey<ProductRecord, CompanyRecord> PRODUCT__PRODUCT_COMPANY_ID_FKEY = Internal.createForeignKey(Product.PRODUCT, DSL.name("product_company_id_fkey"), new TableField[] { Product.PRODUCT.COMPANY_ID }, Keys.COMPANY_PK, new TableField[] { Company.COMPANY.ID }, true);
}
